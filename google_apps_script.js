...
function sendEmailNotification(bookingData) {
    var recipient = "mdzubaira00786@gmail.com";
    var subject = "🚨 URGENT: New Booking - " + bookingData.full_name;
    var body =
        "New Booking Received!\n\n" +
        "Name: " + bookingData.full_name + "\n" +
        "Date: " + bookingData.booked_date + "\n" +
        "Mobile: " + bookingData.mo_number + "\n" +
    ...
    try {
        MailApp.sendEmail({
            ...
            subject: subject,
            body: body,
            name: "Hotel Booking Bot" // Shows as Sender Name
        });
    } catch (e) {
